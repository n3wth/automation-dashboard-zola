...
test.describe('Projects', () => {
  test.skip('should allow a user to create a new project', async ({ page }) => {
  ...
  test.skip('should allow a user to view a project', async ({ page }) => {
    const helpers = new TestHelpers(page)
    // 1. Log in
    // 2. Navigate to the projects page
  ...
  test.skip('should allow a user to delete a project', async ({ page }) => {
    const helpers = new TestHelpers(page)
    // 1. Log in
